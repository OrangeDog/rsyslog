...
// rsRetVal osslCtxInit(net_ossl_t *const pThis, const SSL_METHOD *method);

/*-----------------------------------------------------------------------------*/

/* Prototypes for openssl helper functions */
__attribute__((visibility("default"))) void net_ossl_handle_lastOpenSSLErrorMsg
...
// #define LM_NET_OSSL_FILENAME "libnet_ossl"
